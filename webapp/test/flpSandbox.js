			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsinvoices-display": {
								"semanticObject": "nsinvoices",
								"action": "display",
								"description": "Invoices List SAP Fiori app.",
								"title": "Invoices List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.invoices",
									"url": sap.ui.require.toUrl("ns/invoices")
								}
							}
						}
					}
